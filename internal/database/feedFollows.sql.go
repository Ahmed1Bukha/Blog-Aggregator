...
const deleteTableFeedsFollow = `-- name: DeleteTableFeedsFollow :exec
DELETE FROM feed_follows
`

func (q *Queries) DeleteTableFeedsFollow(ctx context.Context) error {
	_, err := q.db.ExecContext(ctx, deleteTableFeedsFollow)
	return err
}
